...
function SectionHeading({
  ...
  return (
    <div style={{ marginBottom: "42px" }}>
      ...
      {description ? (
        <p className="body-large" style={{ maxWidth: "760px", margin: "16px 0 0" }}>
          {description}
        </p>
      ) : null}
    </div>
    ...
    <div className="site-shell">
      ...
      <header className="site-nav">
        <div className="site-nav-inner">
          <a className="brand" href="#top" aria-label="Parsa Tak home">
        ...
        <section className="hero">
          <div className="page-container hero-grid">
            <div className="hero-copy">
              ...
              <p className="kicker">PARSA TAK / INDEPENDENT BUILDER</p>

              <h1 className="hero-title" style={{ marginTop: "14px" }}>
                Building AI systems,
                <br />
                <span className="hero-title-accent">living worlds</span>
                <br />
                & ideas.
              </h1>
              ...
              <p className="body" style={{ maxWidth: "720px", marginTop: "20px" }}>
                This is the public laboratory of an independent builder working
                across AI systems, reasoning architecture, creative technology,
                system design, and experimental worlds.
              </p>
            ...
            <div className="hero-magic" aria-label="RED MAGIC living organism">
          ...
          <div className="page-container">
            ...
            <div className="two-column">
              <div className="glow-border">
                <article className="panel panel-red">
                  <div className="panel-content">
                    <p className="body-large">
                      Parsa Tak is an independent creator and systems-oriented
                      builder whose work increasingly centres on artificial
                      intelligence, reasoning, design, and experimental
                      technology.
                    </p>

                    <p className="body" style={{ marginTop: "22px" }}>
                      The direction moved naturally from prompts and isolated
                      experiments toward architecture: systems that can reason
                      deliberately, preserve context, use tools intelligently,
                      verify what matters, and remain understandable as they
                      evolve.
                    </p>

                    <p className="body" style={{ marginTop: "22px" }}>
                      The creative side is equally important. AI, visual art,
                      narrative, philosophy, design, strategy, and simulation
                      are treated as connected materials rather than separate
                      disciplines.
                    </p>
                  </div>
                </article>
              ...
              <div style={{ display: "grid", gap: "16px" }}>
                <article className="panel">
                  <div className="panel-content">
                    ...
                    <h2 style={{ margin: "12px 0 0", fontSize: "26px" }}>
                      Curious. Intense. Systemic.
                    </h2>
                    <p className="body" style={{ marginTop: "10px" }}>
                      Look for patterns, weak points, hidden assumptions, and
                      stronger structures.
                    </p>
                  </div>
                </article>
                ...
                <article className="panel">
                  <div className="panel-content">
                    ...
                    <p className="body" style={{ marginTop: "10px" }}>
                      Ideas become prototypes. Stronger versions survive
                      criticism; weaker versions are replaced.
                    </p>
                  </div>
                </article>
                ...
                <article className="panel">
                  <div className="panel-content">
                    ...
                    <p className="body" style={{ marginTop: "10px" }}>
                      Freedom to explore, discipline to verify, and enough
                      imagination to see possibilities early.
                    </p>
                  </div>
                </article>
              </div>
        ...
        <section id="systems" className="section">
          <div className="page-container">
            ...
            <div className="three-column">
              {systems.map((system) => (
                <article className="glow-border" key={system.number}>
                  <div className="panel system-card">
                    <div className="panel-content">
                      ...
                      <p className="system-copy">{system.copy}</p>
                    </div>
                  </div>
                </article>
              ))}
            ...
            <div className="glow-border" style={{ marginTop: "20px" }}>
              <div className="panel panel-red">
                <div className="panel-content relationship">
                  <div>
                    ...
                    >
                      <span className="hero-title-accent">Govern</span>
                      {" → "}
                      <span className="hero-title-accent">Reason</span>
                      {" → "}
                      <span className="hero-title-accent">Improve</span>
                    </p>
                  </div>

                  <p className="quote">
                    AI Instructions establishes the environment. REP strengthens
                    reasoning behaviour inside it. USEF supplies the discipline
                    for evolving the system itself.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="path" className="section">
          <div className="page-container">
            ...
            <div className="two-column">
              <article className="panel panel-red">
                <div className="panel-content">
                  <p className="kicker">THE DIRECTION</p>

                  <p className="body-large" style={{ marginTop: "18px" }}>
                    Build less noise. Create more leverage.
                  </p>

                  <p className="body" style={{ marginTop: "18px" }}>
                    The next generation of the work should be smaller where
                    possible, stronger where necessary, and transparent enough
                    that another person—or another model—can understand the
                    architecture.
                  </p>

                  <p className="quote" style={{ marginTop: "28px" }}>
                    The goal is not complexity. The goal is capability that
            ...
            <div className="glow-border">
              <article className="panel panel-red">
                <div className="panel-content">
                  ...
                  >
                    <div>
                      <p className="kicker">PUBLIC WORK</p>

                      <h2 className="section-title" style={{ fontSize: "42px" }}>
                        The laboratory is public.
                      </h2>

                      <p
                        className="body"
                        style={{ maxWidth: "690px", marginTop: "16px" }}
                      >
                        The ideas, systems, experiments, and future iterations
                        are organized openly on GitHub.
                      </p>
                    </div>
      ...
      <footer className="site-footer">
        <div className="page-container footer-inner">
          <span className="footer-mark">
            © 2026 Parsa Tak · An evolving public laboratory.
          </span>

          <span>AI systems · reasoning · creative architecture · RED MAGIC</span>
        </div>
      </footer>
    </div>
  );
